...
public class Fornecedor {
    ...
    /**
     * Adiciona um como a partir do nome do combo, descricao do combo, preco final, preco inicial e o fator de desconto
     * de um combo.
     *
     * @param nomeCombo      para o nome do combo.
     * @param descricaoCombo para a descricao do combo.
     * @param precoFinal     para o preco final do combo.
     * @param precoIntegral  para o preco inicial do combo.
     * @param fator          para o fator de desconto de um comto.
     */
    public void adicionaCombo(String nomeCombo, String descricaoCombo, double precoFinal, double precoIntegral, double fator) {
        if (this.produtos.containsKey(nomeCombo + descricaoCombo)) {
            throw new IllegalArgumentException("Erro no cadastro de combo: combo ja existe.");
        }
        this.produtos.put(nomeCombo + descricaoCombo, new ProdutoCombo(nomeCombo, descricaoCombo, precoFinal, precoIntegral, fator));
        this.produtosCadastrados.add(nomeCombo + descricaoCombo);
        for (int i = this.produtosCadastrados.size() - 1; i > 0; i--) {
            String produto1 = this.produtosCadastrados.get(i);
            String produto2 = this.produtosCadastrados.get(i - 1);
            Produto p1 = this.produtos.get(produto1);
    ...
    /**
     * Consulta um produto a partir do nome e a descricao de um produto.
     *
     * @param nomeProduto      para o nome do produto.
     * @param descricaoProduto para a descricao do produto.
     * @return o produto a partir da concatenacao do nome e descricao de um produto.
     */
    ...
    /**
     * Edita um combo a partir do nome, descricao e o o novo fator a ser editado de um combo.
     *
     * @param nomeCombo      para o nome do combo.
     * @param descricaoCombo para a descricao do combo.
    ...
    public void editaCombo(String nomeCombo, String descricaoCombo, double novoFator) {
        ...
        this.produtos.get(nomeCombo + descricaoCombo).modificaProduto(novoFator);
    }
