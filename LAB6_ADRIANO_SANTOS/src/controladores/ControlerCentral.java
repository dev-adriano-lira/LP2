...
/**
 * Classe que controla os demais controladores e se comunica com a facade.
 *
...
public class ControlerCentral {
    ...
    /**
     * Adiciona um combo a partir do nome do fornecedor, nome do combo, descricao do combo, fator e os produtos do combo.
     *
    ...
    /**
     * Edita um combo a partir do nome do combo, descricao do combo, fornecedor e o novo fator.
     *
     * @param nomeCombo      para o nome do combo.
     * @param descricaoCombo para a descricao do combo.
     * @param fornecedor     para o nome do fornecedor.
