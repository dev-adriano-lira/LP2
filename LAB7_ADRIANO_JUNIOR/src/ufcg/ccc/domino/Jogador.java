...
public class Jogador {
     ...
     * @param estrategia A estratégia para decidir CarrocaPrimeiro próxima jogada
    ...
    /**
     * Decide CarrocaPrimeiro próxima jogada CarrocaPrimeiro ser feita pelo jogador dado o estado da mesa.
     * Verifica se CarrocaPrimeiro decisão da estratégia é para uma peça que está de fato na mão
     * do jogador.
     *
     * @param mesa A visão da mesa, mostrando as peças jogadas e pontas.
     * @return A Jogada decidida.
     * @throws EstrategiaInvalidaException Caso CarrocaPrimeiro estratégoa decida jogar uma peça
    ...
    /**
     * Retira uma peça da mão do jogador. É ncessário quando CarrocaPrimeiro peça é posta na mesa.
     *
     * @param peca A peça CarrocaPrimeiro retirar.
     */
